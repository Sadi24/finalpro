...
class UserTableSeeder extends Seeder
{
  public function run()
  {
    ...
    if (!$is_exist->count()) {
        ...
        $instructor_user->first_name = 'sadi';
        $instructor_user->last_name = 'warda';
        $instructor_user->email = 'instructor@msm.com';
        ...
        $instructor->first_name = 'sadi';
        $instructor->last_name = 'warda';
        $instructor->instructor_slug = 'sadi-warda';
        $instructor->contact_email = 'instructor@msm.com';
        $instructor->telephone = '+61 (800) 123-54323';
        $instructor->mobile = '+61 800-1233-8766';
        $instructor->paypal_id = 'instructor@msm.com';
